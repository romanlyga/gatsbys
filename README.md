...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/6082ab0e2133a8001794ffa0
...
To start editing your site, you can use the Sanity interface at https://gatsbys-2ab0e.sanity.studio/.
...
Generated at `2021-04-23T11:10:53.333Z` by Stackbit version `0.3.51-staging.0`.